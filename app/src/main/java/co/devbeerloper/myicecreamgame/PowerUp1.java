...
public class PowerUp1 {
    ...
    public PowerUp1(Context context, float screenWidth, float screenHeigth){
    ...
    public PowerUp1(Context context, float initialX, float initialY, float screenWidth, float screenHeigth){
