...
public class BoyCream {
    ...
    public BoyCream(Context context, float screenWidth, float screenHeigth){
    ...
    public BoyCream(Context context, float initialX, float initialY, float screenWidth, float screenHeigth){
